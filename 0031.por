programa {
  funcao inicio() {
    ...
    /*
     * Neste exemplo, a operação de diverção de divisão (/) será executado primeiro,
     * seguida pela operação de multiplicação (*). por último, será]
     * exercutada a operação de soma (+)
     */
    resultado = 1.0 + 2.0 / 3.0 * 4.0
    escreva("\nOperação: 1 + 2 / 3 * 4 = ", resultado)
    /*
     * Neste exermplo, a operação de soma (+) será executada primeiro,
     * seguida pela operação de multiplicação (*). Por último, será
